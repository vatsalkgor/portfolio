            ...
            <Row className="description d-flex align-items-center">
                ...
                <Col md={6} sm={12}>
                    <p>
                        ...
                        Music as a tool for refreshment.
                    </p>
                    <p>
                        I like watching movies (who doesn't? LOL!). Though I
                        watch super-hero movies, I'm not a big enthusiast about
                        them. In short Sorry! I don't understand super-hero
                        memes! My favourite genres are Mystery, Thriller and
                        Comedy!
                    </p>
                    <p>
                        If you ask me to choose between F.R.I.E.N.D.S. and TBTT,
                        I would go for (obviously) the later!
                    </p>
                    <p>
                    ...
                    <p>
                        ...
                        writing. Initially, I've started writing excerpts from
                        the books I read to remember the essence of the book.
                    </p>
                    <p>
                        In a situation of exploration/exploitation trade-off, I
                        always choose exploration because I believe life is long
                        and I've time to explore everything.
                    </p>
